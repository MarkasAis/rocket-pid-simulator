class Rocket {
    constructor() {
        this.body = new Rigidbody2D(Vec2.zero, 0, 1, 1);
    ...
    update(dt) {
        ...
        // this.body.position.y = this.wrap(this.body.position.y, -6, 6)
        this.body.position = Vec2.zero
    }

    render() {
        rect(this.body.position, this.size, this.body.angle);

        ray(this.body.position, this.body.velocity, 3, '#ff0000dd');
        ray(this.body.position, this.body.linearAcceleration, 3, '#00ff00dd');
        ...
        ray(worldThrust, thrustDir, 3, '#0000ffdd');
    }
}