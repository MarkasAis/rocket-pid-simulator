...
export function circle(pos, r, color = '#000') {
...
export function line(start, end, thickness, color = '#000') {
...
export function ray(start, dir, thickness, color = '#000') {
    let end = Vec2.add(start, dir);
    line (start, end, thickness, color);
}

export function rect(pos, size, angle, color = '#000') {
